...
=========================| Strength Training by Phantom.of.the.Server |========================
 ...
 - Based on SNK's Art Of Fighting 2 bonus stage with the same name
...
=====<Features>=====
 ...
 - Intro based on the original
 - Custom time, score, and life display
...
<01.05.2022>
 ...
 - Players can now use ground recovery when tripped by an enemy

<12.01.2010>
 - For Mugen 1.0 now

<23.03.09>
 - Fixed a couple of small mistakes
 - Doubled the default max life of each enemy

<27.01.09>
 - Now supports using two bonus games in simul mode

<v.1.1>
 - KO'ed thugs now stay in the screen during the char's victory pose
 - Fixed intro bug in turns/survival modes
